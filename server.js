...
app.get('/api/export-csv', async (req, res) => {
  try {
    ...
    res.setHeader('Content-Disposition', 'attachment; filename=grip-strength-challenge-participants.csv');
    res.send(csv);
  } catch (err) {
...
// Start server
app.listen(PORT, () => {
  console.log(`💪 Grip Strength Challenge API running on port ${PORT}`);
